...
def get_columns():
    ...
    return [
        ...
        {"fieldname": "shift", "label": _("Shift Type"), "fieldtype": "Data", "width": 80},
        {"fieldname": "first_checkin", "label": _("First Checkin"), "fieldtype": "Data", "width": 100},
        {"fieldname": "last_checkout", "label": _("Last Checkout"), "fieldtype": "Data", "width": 100},
...
def get_attendance_data(conditions, filters):
    """Get attendance data and compute daily rows."""
