...
def get_attendance_data(conditions, filters):
    ...
    for key in all_keys:
        ...
        # Missing checkin or checkout = incomplete record, should NOT be included in aggregation
        # This prevents payment errors and ensures accurate weekly calculations
    ...
    for row in attendance_data:
        emp = row["employee"]
        # Count days: Each row = 1 checkin/checkout pair = 1 day worked (regardless of hours)
    ...
    for emp, sums in period_sums.items():
        ...
        agg_row = {
            ...
            "total_worked_hours": hours_display,
            "overtime_tsh": sums["overtime_tsh"],
            "extra_overtime": sums["extra_overtime"],
            "total_overtime": sums["total_overtime"],
        }
